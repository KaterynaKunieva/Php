...
<body><?php
        $rightAnswers = array("rightAnswer1" => "programingLanguage", "rightAnswer2" => "toServredCreateUpdate");

        $score = 0;
        foreach ($rightAnswers as $rightAnswer) {
            if (array_search($rightAnswer, $_SESSION)) {
                $score++;
            }
        }
        echo "<br>";
        ...
        echo "<br>";
        print "This is: ";
        print $score / count($rightAnswers) * 100;
        print "%";
        echo "<br>";

        session_destroy();
        print "<a href=page1.php>Rerun test</a>";
        ?>
